...
Quick reference for trying different Ollama models with this plugin.
...
## Recommended Models for Post Generation
...
### In WordPress
1. Go to **Settings > AI Client**
2. Select **Ollama** as provider
3. All pulled models appear in the model dropdown

## Switching Models in WordPress

1. Pull the model you want to try (if not already pulled)
2. Go to **Settings > AI Client** in WordPress admin
3. Provider: Select **Ollama**
4. Model: Select the model from dropdown
5. Click **Save Changes**
6. Go to **Tools > WP AI SDK Demo** to test
...
Larger models take longer to generate text. Update the timeout in `wp-ai-sdk-demo.php`:
...
# Test each one in WordPress:
# 1. Go to Settings > AI Client
# 2. Select model
# 3. Go to Tools > WP AI SDK Demo
# 4. Generate a test post with same prompt
# 5. Compare quality vs speed
```

## Current Model Information

To see which model is currently active in WordPress:

1. Go to **Settings > AI Client**
2. Check the **Provider** field (should show "Ollama")
3. Check the **Model** dropdown (shows currently selected model)

The plugin automatically uses this configuration when generating content.
